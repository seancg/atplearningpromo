...
if(!empty($name) && !empty($email) && !empty($message))
{
    ...
    $subject   = "Message sent through your NPR17 promo page contact form.";
    $message   = "Someone has requested to be contacted via the ATP Learning Promo - NPR17 (http://www.atplearningpromo.com/electrical/NPR17) landing page:";
