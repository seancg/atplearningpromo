...
if(!empty($name) && !empty($email) && !empty($message))
{
    ...
    $subject   = "Message sent through your ES17 promo page contact form.";
    $message   = "Someone has requested to be contacted via the ATP Learning Promo - ES17 (http://www.atplearningpromo.com/electrical/ES17) landing page:";
