...
if(!empty($name) && !empty($email) && !empty($message))
{
    ...
    $subject   = "Message sent through your WELL contact form.";
    $message   = "Someone has requested to be contacted via the ATP Learning Promo - WELL (http://www.atplearningpromo.com/construction/WELL) landing page:";
