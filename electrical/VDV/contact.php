...
if(!empty($name) && !empty($email) && !empty($message))
{
    ...
    $subject   = "Message sent through your VDV promo page contact form.";
    $message   = "Someone has requested to be contacted via the ATP Learning Promo - VDV (http://www.atplearningpromo.com/electrical/VDV) landing page:";
