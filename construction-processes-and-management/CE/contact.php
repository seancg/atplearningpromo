...
if(!empty($name) && !empty($email) && !empty($message))
{
    ...
    $subject   = "Message sent through your Construction Estimating contact form.";
    $message   = "Someone has requested to be contacted via the ATP Learning Promo - IND (http://www.atplearningpromo.com/construction/CE) landing page:";
