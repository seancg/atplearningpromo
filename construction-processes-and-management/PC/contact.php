...
if(!empty($name) && !empty($email) && !empty($message))
{
    ...
    $subject   = "Message sent through your Principles of Contracting contact form.";
    $message   = "Someone has requested to be contacted via the ATP Learning Promo - Principles of Contracting (http://www.atplearningpromo.com/construction/PC) landing page:";
