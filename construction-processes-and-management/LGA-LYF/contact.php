...
if(!empty($name) && !empty($email) && !empty($message))
{
    ...
    $subject   = "Message sent through your LEED Green contact form.";
    $message   = "Someone has requested to be contacted via the ATP Learning Promo - WELL (http://www.atplearningpromo.com/construction/LGA-LYF) landing page:";
