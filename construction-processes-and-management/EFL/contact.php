...
if(!empty($name) && !empty($email) && !empty($message))
{
    ...
    $subject   = "Message sent through your EFL contact form.";
    $message   = "Someone has requested to be contacted via the ATP Learning Promo - EFL (http://www.atplearningpromo.com/construction/EFL) landing page:";
