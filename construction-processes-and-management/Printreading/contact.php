...
if(!empty($name) && !empty($email) && !empty($message))
{
    ...
    $subject   = "Message sent through your Printreading contact form.";
    $message   = "Someone has requested to be contacted via the ATP Learning Promo - Printreading (http://www.atplearningpromo.com/construction/Printreading) landing page:";
