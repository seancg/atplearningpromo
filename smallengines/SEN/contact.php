...
if(!empty($name) && !empty($email) && !empty($message))
{
    ...
    $subject   = "Message sent through your SEN contact form.";
    $message   = "Someone has requested to be contacted via the ATP Learning Promo - Small Engines (http://www.atplearningpromo.com/smallengines/SEN) landing page:";
