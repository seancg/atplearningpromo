...
if(!empty($name) && !empty($email) && !empty($message))
{
    ...
    $subject   = "Message sent through your Industrial Maintenance and Troubleshooting contact form.";
    $message   = "Someone has requested to be contacted via the ATP Learning Promo - IND (http://www.atplearningpromo.com/maintenance/IND) landing page:";
