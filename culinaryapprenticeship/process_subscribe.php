...
if($_POST) {
    ...
    $subject = "Mailing List Subscription Sent from ATP Learning Promo-KT";
    ...
    $message .= "<p style=\"font-family: Arial, sans-serif\">Someone has submitted a request to join our mailing list via the <b>ATP Learning Promo - KT (http://www.atplearningpromo.com/culinary/KT/)</b> landing page.</p>";
